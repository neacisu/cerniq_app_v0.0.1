...
export async function alertClientPaymentReminderProcessor(
  ...
  const templates = {
    FIRST: {
      whatsapp: "payment_reminder_1",
      email: "payment_reminder_friendly",
    },
    SECOND: {
      whatsapp: "payment_reminder_2",
      email: "payment_reminder_urgent",
    },
    FINAL: {
      whatsapp: "payment_reminder_final",
      email: "payment_reminder_legal",
    },
  };
    ...
    blocks: [
      ...
      },
      {
        ...
        elements: [
          ...
          {
            type: "button",
            text: { type: "plain_text", text: "Aprobă override" },
            action_id: "approve_credit_override",
            value: orderId,
          },
        ],
      },
