            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Textarea
                    {...field}
                    placeholder="Explicați de ce este necesară această excepție..."
                    rows={3}
                  />
                  <FormMessage />
                </FormItem>
            ...
            {invoices?.map((invoice) => (
              ...
              >
                <div className="flex justify-between">
                  ...
                  <span
                    className={`font-medium ${Math.abs(invoice.totalAmount - payment.amount) < 0.01 ? "text-green-600" : ""}`}
                  >
                ...
                {order.items.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-gray-500">
                        Cantitate comandată: {item.quantity}
                      </div>
                    </div>
