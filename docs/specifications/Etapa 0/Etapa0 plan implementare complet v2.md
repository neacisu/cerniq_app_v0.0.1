...
| ---- | -------- | ----------- |
| F0.1 | Infrastructură Docker de Bază | 6 |
| F0.2 | PostgreSQL 18.1 Setup | 5 |
| F0.3 | Redis 7.4.7 și BullMQ Setup | 4 |
...
```json
{
  ...
  "restrictii_antihalucinatie": [
    ...
    "VERIFICĂ versiunea este 18.x în imaginea postgis/postgis:18-3.5",
...
{
  "taskID": "F0.5.1.T001",
  "denumire_task": "Adăugare servicii SigNoz v0.104.0 în docker-compose.yml",
...
{
  "taskID": "F0.6.1.T004",
  "denumire_task": "Creare package apps/web cu React 19 și Refine v5",
  "context_anterior": "Package API creat. Acum creăm package-ul pentru frontend.",
  "descriere_task": "Ești un expert frontend React. Task-ul tău este să creezi package-ul apps/web.\n\nCreează /var/www/CerniqAPP/apps/web/package.json:\n```json\n{\n  \"name\": \"@cerniq/web\",\n  \"version\": \"0.1.0\",\n  \"private\": true,\n  \"type\": \"module\",\n  \"scripts\": {\n    \"dev\": \"vite\",\n    \"build\": \"tsc && vite build\",\n    \"preview\": \"vite preview\",\n    \"test\": \"vitest run\",\n    \"lint\": \"eslint src/\"\n  },\n  \"dependencies\": {\n    \"react\": \"^19.0.0\",\n    \"react-dom\": \"^19.0.0\",\n    \"@refinedev/core\": \"^5.0.0\",\n    \"@refinedev/react-router\": \"^1.0.0\",\n    \"react-router-dom\": \"^7.0.0\",\n    \"@tanstack/react-query\": \"^5.62.0\",\n    \"zod\": \"^3.24.0\",\n    \"@cerniq/shared-types\": \"workspace:*\"\n  },\n  \"devDependencies\": {\n    \"@types/react\": \"^19.0.0\",\n    \"@types/react-dom\": \"^19.0.0\",\n    \"typescript\": \"^5.7.0\",\n    \"vite\": \"^6.0.0\",\n    \"@vitejs/plugin-react\": \"^4.3.0\",\n    \"tailwindcss\": \"^4.0.0\",\n    \"vitest\": \"^2.1.0\",\n    \"eslint\": \"^9.17.0\"\n  },\n  \"engines\": {\n    \"node\": \">=24.0.0\"\n  }\n}\n```\n\nCreează tsconfig.json și vite.config.ts corespunzătoare.",
...
| ---- | ----------- | ------ |
| F0.1 Infrastructură Docker | 6 | ✅ Definite complet |
| F0.2 PostgreSQL 18.1 | 5 | ✅ Definite complet |
| F0.3 Redis 7.4.7 + BullMQ | 4 | ✅ Definite complet |
| F0.4 Traefik v3.6.6 | 4 | ✅ Definite complet |
| F0.5 Observability SigNoz | 4 | ✅ Definite complet |
