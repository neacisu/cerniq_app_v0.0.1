...
// Categories
export const goldProductCategories = pgTable(
  "gold_product_categories",
  {
    ...
    defaultMaxDiscount: decimal("default_max_discount", {
      precision: 5,
      scale: 2,
    }).default("15.00"),
...
// Products
export const goldProducts = pgTable(
  "gold_products",
  {
    id: uuid("id").primaryKey().defaultRandom(),
    tenantId: uuid("tenant_id")
    ...
    volumeDiscountPercent: decimal("volume_discount_percent", {
      precision: 5,
      scale: 2,
    }),
