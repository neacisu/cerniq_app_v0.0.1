    ...
    try {
      ...
      await db
        ...
        .set({
          ...
          dataInceputTva: companyData.dataInceputScpTVA
            ? new Date(companyData.dataInceputScpTVA)
            : null,
          dataSfarsitTva: companyData.dataSfarsitScpTVA
            ? new Date(companyData.dataSfarsitScpTVA)
            : null,
          tvaLaIncasare: companyData.sistemTVAIncasare || false,
          inregistratEFactura: companyData.eFactura || false,
          dataInregistrareEFactura: companyData.dataEFactura
            ? new Date(companyData.dataEFactura)
            : null,
