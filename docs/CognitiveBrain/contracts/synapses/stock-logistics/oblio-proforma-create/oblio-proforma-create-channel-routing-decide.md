...
- **Semantic (ADR-0002):** sursă [`NEURON_MATRIX.csv`](../../../../NEURON_MATRIX.csv) **L140**; **Destinație (coadă):** `channel:routing:decide` la **L131** (`catalog_nodekey_v2` gol — vezi contract neuron).
