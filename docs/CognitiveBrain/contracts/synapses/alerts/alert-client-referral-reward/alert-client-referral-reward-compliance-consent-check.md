# Sinapsă `alert-client-referral-reward-compliance-consent-check`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `alert-client-referral-reward-compliance-consent-check` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/alerts/alert-client-referral-reward/alert-client-referral-reward-compliance-consent-check.md` |
...
Dependența leagă alertarea de **recompensă referral** de verificarea **consimțământ / conformitate** în planificare. v2: **„sinapsă canonică de pipeline”**. În cod, logica apropiată este K56 + ciclul `referral:consent:*` — vezi contractul neuron, fără a pretinde că alerta enfilează direct jobul nominal.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`alert-client-referral-reward-compliance-consent-check\``.
