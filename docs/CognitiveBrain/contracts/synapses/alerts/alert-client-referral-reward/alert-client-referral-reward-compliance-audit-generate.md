# Sinapsă `alert-client-referral-reward-compliance-audit-generate`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `alert-client-referral-reward-compliance-audit-generate` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/alerts/alert-client-referral-reward/alert-client-referral-reward-compliance-audit-generate.md` |
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`alert-client-referral-reward-compliance-audit-generate\``.
