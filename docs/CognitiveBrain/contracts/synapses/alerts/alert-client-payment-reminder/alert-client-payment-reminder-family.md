# Sinapsă `alert-client-payment-reminder-family`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `alert-client-payment-reminder-family` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/alerts/alert-client-payment-reminder/alert-client-payment-reminder-family.md` |
...
Muchia **default** cu descrierea **„specializează familia”** ancorează traseul de alertă **reminder plată (client)** în nucleul `e4-alerts` din graf. v2 §7 nu definește payload sau ordinea față de alte alerte; reconcilierea la cozi reale trece prin contractul neuron sursă și prin infrastructura generică I39–I44, nu prin câmpurile sinapsei.
...
- **Runtime (ADR-0001):** pentru `alert:client:payment-reminder`, **nu** există intrare 1:1 în `queue-registry.ts` la auditul din contractul neuron; pentru alerte E4 implementate, vezi constantele `E4_ALERT_*`. Pentru `e4-alerts`, doar planificare agregată.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — **7. Complete synapse contract register**, bloc `SYNAPSE \`alert-client-payment-reminder-family\``.
