# Sinapsă `alert-internal-delivery-cluster-compliance-optout-process`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `alert-internal-delivery-cluster-compliance-optout-process` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/alerts/alert-internal-delivery-cluster/alert-internal-delivery-cluster-compliance-optout-process.md` |
...
**Alerta internă cluster livrări** este legată canonic de **procesarea opt-out / retrageri** (etichetă v2). v2: **„sinapsă canonică de pipeline”**; exportul nu descrie canalul sau starea lead-ului.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`alert-internal-delivery-cluster-compliance-optout-process\``.
