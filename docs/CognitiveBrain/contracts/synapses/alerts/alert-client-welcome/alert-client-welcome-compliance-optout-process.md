# Sinapsă `alert-client-welcome-compliance-optout-process`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `alert-client-welcome-compliance-optout-process` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/alerts/alert-client-welcome/alert-client-welcome-compliance-optout-process.md` |
...
Dependența plasează alertarea de **bun venit** în raport cu **procesarea opt-out** din graf. v2: **„sinapsă canonică de pipeline”**. Interpretare conservatoare: planificarea cere poziție canonică față de retragerea consimțământului; runtime-ul actual nu expune o singură coadă `compliance:optout:process`.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`alert-client-welcome-compliance-optout-process\``.
