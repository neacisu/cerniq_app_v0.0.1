# Sinapsă `alert-internal-nps-drop-compliance-data-anonymize`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `alert-internal-nps-drop-compliance-data-anonymize` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/alerts/alert-internal-nps-drop/alert-internal-nps-drop-compliance-data-anonymize.md` |
...
**Alerta internă scădere NPS** este legată canonic de **anonimizarea datelor în sfera compliance** (v2). v2: **„sinapsă canonică de pipeline”**; exportul nu leagă explicit alerta de cron-ul J47.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`alert-internal-nps-drop-compliance-data-anonymize\``.
