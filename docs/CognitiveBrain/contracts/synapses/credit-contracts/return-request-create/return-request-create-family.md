...
- Muchiile din alte foldere care au ca destinație `return-request-create` (ex. pași contract) sunt sinapse **distincte** în v2 §7 — nu le confunda cu manifestul de familie.
