# Sinapsă `credit-release-order-contract-template-select`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `credit-release-order-contract-template-select` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/credit-contracts/credit-release-order/credit-release-order-contract-template-select.md` |
...
Traseul **credit-release-order** depinde în planificare de **selecția șablonului / clauzelor**. v2: **„sinapsă canonică de pipeline”**; exportul nu descrie reguli de selecție.
...
- **Planificare:** v2 §7 — `credit-release-order` → `contract-template-select`.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`credit-release-order-contract-template-select\``.
