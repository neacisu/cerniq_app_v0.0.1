# Sinapsă `human-queue-prioritize-pipeline-ai-sales-cleanup`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `human-queue-prioritize-pipeline-ai-sales-cleanup` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/hitl-human/human-queue-prioritize/human-queue-prioritize-pipeline-ai-sales-cleanup.md` |
...
În planificare, traseul **human-queue-prioritize** are dependență sintactică față de nodul **pipeline-ai-sales-cleanup**. v2: **„sinapsă canonică de pipeline”**; exportul **nu** descrie relația cauzală între prioritizare și curățare pipeline.
...
- **Planificare:** v2 §7 — `human-queue-prioritize` → `pipeline-ai-sales-cleanup`.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`human-queue-prioritize-pipeline-ai-sales-cleanup\``.
