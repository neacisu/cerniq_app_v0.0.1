# Sinapsă `human-notification-send-report-conversion-analyze`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `human-notification-send-report-conversion-analyze` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/hitl-human/human-notification-send/human-notification-send-report-conversion-analyze.md` |
...
În planificare, traseul **human-notification-send** are dependență sintactică față de nodul **report-conversion-analyze**. v2: **„sinapsă canonică de pipeline”**; exportul **nu** descrie intrările raportului sau legătura cu notificările.
...
- **Planificare:** v2 §7 — `human-notification-send` → `report-conversion-analyze`.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`human-notification-send-report-conversion-analyze\``.
