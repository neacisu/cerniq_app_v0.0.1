# Sinapsă `guardrail-stock-check-einvoice-archive-download`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `guardrail-stock-check-einvoice-archive-download` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/ai-agent/guardrail-stock-check/guardrail-stock-check-einvoice-archive-download.md` |
...
- **Runtime (ADR-0001):** `E3_GUARDRAIL_STOCK_CHECK`; `E3_EINVOICE_ARCHIVE_DOWNLOAD`.
...
- **Planificare:** v2 §7 — `guardrail-stock-check` → `einvoice-archive-download`.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`guardrail-stock-check-einvoice-archive-download\``.
