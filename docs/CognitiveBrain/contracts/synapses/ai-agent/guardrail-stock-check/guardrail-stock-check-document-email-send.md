...
- **Semantic (ADR-0002):** sursă — guardrail stoc determinist (~L2161–2168); țintă — `e3:document:email-send` / `document:email:send` — „Trimitere document fiscal/comercial via email…” (~L1974–1979), MotorNeuron, `fiscal-execution`.
