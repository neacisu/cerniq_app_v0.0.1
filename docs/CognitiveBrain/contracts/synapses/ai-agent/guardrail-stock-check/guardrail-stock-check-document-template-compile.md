# Sinapsă `guardrail-stock-check-document-template-compile`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `guardrail-stock-check-document-template-compile` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/ai-agent/guardrail-stock-check/guardrail-stock-check-document-template-compile.md` |
...
- **Runtime (ADR-0001):** `E3_GUARDRAIL_STOCK_CHECK`; `E3_DOCUMENT_TEMPLATE_COMPILE`.
...
- **Planificare:** v2 §7 — `guardrail-stock-check` → `document-template-compile`.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`guardrail-stock-check-document-template-compile\``.
