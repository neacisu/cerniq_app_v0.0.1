# Sinapsă `guardrail-price-check-document-whatsapp-send`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `guardrail-price-check-document-whatsapp-send` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/ai-agent/guardrail-price-check/guardrail-price-check-document-whatsapp-send.md` |
...
În planificare, trimiterea documentului pe WhatsApp este dependentă de traseul guardrail preț; fără detalii de canal sau payload în registrul §7.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`guardrail-price-check-document-whatsapp-send\``.
