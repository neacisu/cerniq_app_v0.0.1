# Sinapsă `guardrail-price-check-document-pdf-generate`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `guardrail-price-check-document-pdf-generate` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/ai-agent/guardrail-price-check/guardrail-price-check-document-pdf-generate.md` |
...
**Dependency** în planificare: generarea PDF este plasată după (dependentă de) guardrail-ul de preț în topologia exportată. Mecanismul runtime între cozi nu face obiectul câmpurilor v2 §7.
...
- **Runtime (ADR-0001):** `E3_GUARDRAIL_PRICE_CHECK`; `E3_DOCUMENT_PDF_GENERATE`.
...
- **Planificare:** v2 §7 pentru `guardrail-price-check-document-pdf-generate`.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`guardrail-price-check-document-pdf-generate\``.
