# Sinapsă `ai-intent-classify-alert-phone-banned`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `ai-intent-classify-alert-phone-banned` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/ai-agent/ai-intent-classify/ai-intent-classify-alert-phone-banned.md` |
...
| Destinatie (graf) | `alert-phone-banned` | Coadă canonică **`alert:phone:banned`** — [`../../../neurons/E2/alert--phone--banned.md`](../../../neurons/E2/alert--phone--banned.md). |
...
- Slug sursă ↔ execuție **`intent:classify`**. Slug `alert-phone-banned` ↔ **`alert:phone:banned`**. Fără presupuneri despre payload (absent din export).

## Sursă canonică

- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`ai-intent-classify-alert-phone-banned\``.
