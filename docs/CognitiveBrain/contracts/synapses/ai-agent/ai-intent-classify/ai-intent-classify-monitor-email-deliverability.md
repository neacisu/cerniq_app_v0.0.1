# Sinapsă `ai-intent-classify-monitor-email-deliverability`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `ai-intent-classify-monitor-email-deliverability` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/ai-agent/ai-intent-classify/ai-intent-classify-monitor-email-deliverability.md` |
...
| Destinatie (graf) | `monitor-email-deliverability` | Coadă canonică **`monitor:email:deliverability`** — [`../../../neurons/E2/monitor--email--deliverability.md`](../../../neurons/E2/monitor--email--deliverability.md). |
...
- Slug sursă ↔ execuție **`intent:classify`**. Slug `monitor-email-deliverability` ↔ **`monitor:email:deliverability`**. Fără presupuneri despre payload (absent din export).

## Sursă canonică

- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`ai-intent-classify-monitor-email-deliverability\``.
