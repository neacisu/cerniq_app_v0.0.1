...
| Țintă | `negotiation-state-transition` | Coadă canonică **`negotiation:state:transition`** — [`../../../neurons/E3/negotiation--state--transition.md`](../../../neurons/E3/negotiation--state--transition.md). |
