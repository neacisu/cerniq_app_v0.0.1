# Sinapsă `negotiation-state-transition-pricing-margin-check`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `negotiation-state-transition-pricing-margin-check` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/ai-agent/negotiation-state-transition/negotiation-state-transition-pricing-margin-check.md` |
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`negotiation-state-transition-pricing-margin-check\``.
