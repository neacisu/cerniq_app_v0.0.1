# Sinapsă `search-rerank-cross-encoder-mcp-session-manage`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `search-rerank-cross-encoder-mcp-session-manage` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/ai-agent/search-rerank-cross-encoder/search-rerank-cross-encoder-mcp-session-manage.md` |
...
Gestionarea sesiunii MCP depinde în graf de traseul rerank cross-encoder. Exportul nu descrie fluxul de date.
...
- Slug graf vs coadă `mcp:session:manage`.

## Sursă canonică

- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`search-rerank-cross-encoder-mcp-session-manage\``.
