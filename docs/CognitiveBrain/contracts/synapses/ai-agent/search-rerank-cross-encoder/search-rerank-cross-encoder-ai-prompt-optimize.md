# Sinapsă `search-rerank-cross-encoder-ai-prompt-optimize`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `search-rerank-cross-encoder-ai-prompt-optimize` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/ai-agent/search-rerank-cross-encoder/search-rerank-cross-encoder-ai-prompt-optimize.md` |
...
Dependență declarativă între rerank (etichetă graf) și optimizarea promptului. Ambele capete au gap în registry la auditul documentat pentru cozile nominale v2.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`search-rerank-cross-encoder-ai-prompt-optimize\``.
