# Sinapsă `search-index-rebuild-ai-agent-response-generate`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `search-index-rebuild-ai-agent-response-generate` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/ai-agent/search-index-rebuild/search-index-rebuild-ai-agent-response-generate.md` |
...
**Reconstrucția indexului de căutare (A4)** este legată canonic de **generarea răspunsului** (lanțul C15 în repo). v2: **„sinapsă canonică de pipeline”**; fără câmpuri despre formatarea răspunsului sau validare C16.
...
- **Runtime (ADR-0001):** A4 vs cozi răspuns E3/E2.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`search-index-rebuild-ai-agent-response-generate\``.
