...
| Destinație (graf) | `pipeline-outreach-metrics` | Coadă executabilă **`pipeline:outreach:metrics`** (`QUEUES.PIPELINE_OUTREACH_METRICS`) — [`../../../neurons/E2/pipeline--outreach--metrics.md`](../../../neurons/E2/pipeline--outreach--metrics.md). |
