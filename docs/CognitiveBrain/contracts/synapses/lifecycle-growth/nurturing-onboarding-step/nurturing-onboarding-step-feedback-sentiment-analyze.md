# Sinapsă `nurturing-onboarding-step-feedback-sentiment-analyze`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `nurturing-onboarding-step-feedback-sentiment-analyze` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/lifecycle-growth/nurturing-onboarding-step/nurturing-onboarding-step-feedback-sentiment-analyze.md` |
...
În planificare, traseul **nurturing-onboarding-step** are dependență canonică de pipeline față de **feedback-sentiment-analyze**. v2: **„sinapsă canonică de pipeline”**; exportul **nu** fixează payload sau politici de execuție între noduri.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`nurturing-onboarding-step-feedback-sentiment-analyze\``.
