...
| Destinație (graf) | `alert-client-welcome` | **Contract:** [`../../../neurons/E5/alert--client--welcome.md`](../../../neurons/E5/alert--client--welcome.md). **Runtime / semantic:** vezi contract neuron țintă. |
...
- **Runtime (ADR-0001):** vezi registry pentru alerta țintă — contract neuron.
