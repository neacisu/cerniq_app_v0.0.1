# Sinapsă `graph-full-metrics-geo-weather-correlate`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `graph-full-metrics-geo-weather-correlate` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/enrich-data/graph-full-metrics/graph-full-metrics-geo-weather-correlate.md` |
...
Muchia **`dependency`** leagă **`graph-full-metrics`** de **`geo-weather-correlate`**. **Descriere confirmată în v2:** „sinapsă canonică de pipeline”.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`graph-full-metrics-geo-weather-correlate\``.
