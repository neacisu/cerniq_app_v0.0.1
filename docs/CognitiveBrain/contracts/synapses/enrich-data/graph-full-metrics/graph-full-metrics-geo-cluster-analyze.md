# Sinapsă `graph-full-metrics-geo-cluster-analyze`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `graph-full-metrics-geo-cluster-analyze` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/enrich-data/graph-full-metrics/graph-full-metrics-geo-cluster-analyze.md` |
...
Muchia **`dependency`** leagă **`graph-full-metrics`** de **`geo-cluster-analyze`**. **Descriere confirmată în v2:** „sinapsă canonică de pipeline”; fără detalii în export.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`graph-full-metrics-geo-cluster-analyze\``.
