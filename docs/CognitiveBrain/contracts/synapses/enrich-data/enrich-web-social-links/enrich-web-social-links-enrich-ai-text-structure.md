# Sinapsă `enrich-web-social-links-enrich-ai-text-structure`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `enrich-web-social-links-enrich-ai-text-structure` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/enrich-data/enrich-web-social-links/enrich-web-social-links-enrich-ai-text-structure.md` |
...
În planificare, traseul **enrich-web-social-links** are dependență sintactică față de nodul **enrich-ai-text-structure**. v2: **„sinapsă canonică de pipeline”**; exportul **nu** fixează ordinea operațională sau payload-ul între job-uri.
...
- **Planificare:** v2 §7 — `enrich-web-social-links` → `enrich-ai-text-structure`.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`enrich-web-social-links-enrich-ai-text-structure\``.
