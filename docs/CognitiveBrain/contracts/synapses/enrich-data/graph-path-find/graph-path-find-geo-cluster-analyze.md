# Sinapsă `graph-path-find-geo-cluster-analyze`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `graph-path-find-geo-cluster-analyze` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/enrich-data/graph-path-find/graph-path-find-geo-cluster-analyze.md` |
...
Muchia **`dependency`** leagă **`graph-path-find`** de **`geo-cluster-analyze`**. **Descriere confirmată în v2:** „sinapsă canonică de pipeline”.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`graph-path-find-geo-cluster-analyze\``.
