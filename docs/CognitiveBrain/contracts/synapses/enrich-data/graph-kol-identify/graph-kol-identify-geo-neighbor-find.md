# Sinapsă `graph-kol-identify-geo-neighbor-find`

## Identitate

| Câmp | Valoare |
| --- | --- |
| Identificator sinapsă | `graph-kol-identify-geo-neighbor-find` |
| Cale contract | `docs/CognitiveBrain/contracts/synapses/enrich-data/graph-kol-identify/graph-kol-identify-geo-neighbor-find.md` |
...
Muchia **`dependency`** leagă **`graph-kol-identify`** de **`geo-neighbor-find`**. **Descriere confirmată în v2:** „sinapsă canonică de pipeline”.
...
- [`../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md`](../../../../v2_cerniq_cognitive_brain_master_implementation_plan.md) — §7, bloc `SYNAPSE \`graph-kol-identify-geo-neighbor-find\``.
