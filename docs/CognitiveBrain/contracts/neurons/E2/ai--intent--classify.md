...
| 9 | Guardrails | Validare **deterministă** Zod `IntentSchema` după răspuns (`k62-intent-classify.ts` L54–57, L109–110). **Fără** NeMo/Colang în fișierul citat. | v2 + ADR-0007: NeMo + verificări deterministe. | NeMo: destinație documentată, neobservată în K62. |
