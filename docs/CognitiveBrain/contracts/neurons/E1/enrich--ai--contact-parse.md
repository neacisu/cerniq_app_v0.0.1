...
| 9 | Guardrails | **Nu** s-au găsit integrări NeMo/Colang în `j1-grok-structuring.ts`. Validare deterministă: `sanitizeCui`, `validateCuiModulo11` înainte de aplicare (`j1-grok-structuring.ts` L155–156). | v2 + ADR-0007: NeMo + verificări deterministe. | NeMo: țintă arhitecturală, neimplementată în fișierul citat. |
