...
CREATE TABLE gold_companies (
    ...
    cui VARCHAR(12) NOT NULL UNIQUE,
...
-- Indexuri critice
CREATE INDEX idx_gold_companies_cui ON gold_companies(cui);
    ...
    "afilieri": {
      ...
      "properties": {
        ...
        "asociatii_profesionale": {
          ...
          "items": {
            "type": "string",
            "enum": ["LAPAR", "APPR", "PRO_AGRO", "UNCSV", "ALTRE"]
          }
        }
      }
    },
