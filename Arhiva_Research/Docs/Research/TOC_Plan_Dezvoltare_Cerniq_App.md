...
_Audit Complet Documentațe Proiect Cerniq App_
...
7 Etapa*3\_-_Strategie*ș_Plan.rtf Plan Concret Implementare Etapa 3 (9 Sătăâni)
...
- **pg_trgm** - Cătare fuzzy text (BM25)
...
- **company_status:** ENUM (\'ACTIVE\', \'INACTIVE\', \'SUSPENDED\',
  \'RADIATED\')

- **engagement_stage:** ENUM (\'COLD\', \'CONTACTED_WA\',
  \'CONTACTED_EMAIL\', \'WARM_REPLY\', \'NEGOTIATION\', \'CONVERTED\',
  \'DEAD\')

- **verification_level:** ENUM (\'NONE\', \'BASIC\', \'FULL_FISCAL\',
  \'VERIFIED_CONTACT\')
...
_Generat din auditul complet al documentaței proiectului Cerniq App_
