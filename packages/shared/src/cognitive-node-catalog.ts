...
export const COGNITIVE_NODE_CATALOG: CognitiveNodeEntry[] = [
  ...
  // ==========================================================================
  // ETAPA 5 — E5 Nurturing Lifecycle FSM (A1-K58) — 58 noduri cognitive
  // Plan §X FAZA 9b-9h — Lifecycle Management + Churn + Community + Referral
  // ==========================================================================

  // ── A1-A8: Lifecycle FSM Orchestration ────────────────────────────────────
  n(
    "e5:lifecycle:order-completed",
    "lifecycle:order:completed",
    "Cross-etapa bridge A1 — event order DELIVERED din E4 → start FSM E5",
    NeuronType.AutonomicNeuron,
    "lifecycle-fsm-e5",
    5,
    "HIGH",
  ...
  n(
    "e5:lifecycle:state-evaluate",
    "lifecycle:state:evaluate",
    "Evaluare periodică A2 — signal-triggered FSM state check per client",
    NeuronType.AutonomicNeuron,
    "lifecycle-fsm-e5",
    5,
    "HIGH",
  ...
  n(
    "e5:onboarding:sequence-start",
    "onboarding:sequence:start",
    "Start secvență onboarding A3 — client nou → inițiere N pași BullMQ delayed",
    NeuronType.AutonomicNeuron,
    "lifecycle-fsm-e5",
    5,
    "HIGH",
  ...
  n(
    "e5:onboarding:step-execute",
    "onboarding:step:execute",
    "Execuție pas onboarding A4 — delayed job cu tip step (email/call/form)",
    NeuronType.ProceduralNeuron,
    "lifecycle-fsm-e5",
    5,
    "MEDIUM",
  ...
  n(
    "e5:onboarding:complete-check",
    "onboarding:complete:check",
    "Verificare completare onboarding A5 — toate pașii finalizați → tranziție ACTIVE",
    NeuronType.ReflexNeuron,
    "lifecycle-fsm-e5",
    5,
    "MEDIUM",
  ...
  n(
    "e5:state:transition-execute",
    "state:transition:execute",
    "Execuție tranziție FSM A6 — UPDATE stare + log audit + trigger downstream",
    NeuronType.AutonomicNeuron,
    "lifecycle-fsm-e5",
    5,
    "HIGH",
  ...
  n(
    "e5:state:metrics-update",
    "state:metrics:update",
    "Actualizare metrici Prometheus A7 — post-tranziție + daysSinceLastOrder",
    NeuronType.MaintenanceNeuron,
    "lifecycle-fsm-e5",
    5,
    "MEDIUM",
  ...
  n(
    "e5:state:advocate-promote",
    "state:advocate:promote",
    "Promovare ADVOCATE A8 — ≥3 orders + NPS≥8 + ≥2 referrals validat",
    NeuronType.ExecutiveNeuron,
    "lifecycle-fsm-e5",
    5,
    "HIGH",
  ...
  // ── B9-B14: Churn Detection AI ─────────────────────────────────────────────
  n(
    "e5:churn:signal-detect",
    "churn:signal:detect",
    "Detectare semnale churn B9 — rule-based 8 semnale (no-order/inactiv/competitor)",
    NeuronType.PredictiveNeuron,
    "churn-detection",
    5,
    "HIGH",
  ...
  n(
    "e5:churn:score-calculate",
    "churn:score:calculate",
    "Calcul ChurnScore ponderat B10 — formula Σ(signal_strength × weight × confidence)",
    NeuronType.PredictiveNeuron,
    "churn-detection",
    5,
    "HIGH",
  ...
  n(
    "e5:churn:risk-escalate",
    "churn:risk:escalate",
    "Escalare HITL B11 — CRITICAL SLA=2h, HIGH SLA=8h → create HITL task",
    NeuronType.AlertNeuron,
    "churn-detection",
    5,
    "CRITICAL",
  ...
  n(
    "e5:sentiment:analyze",
    "sentiment:analyze",
    "Sentiment analysis AI B12 — PRIMARY QwQ-32B, FALLBACK Claude Sonnet",
    NeuronType.EmotionNeuron,
    "churn-detection",
    5,
    "HIGH",
  ...
  n(
    "e5:sentiment:aggregate",
    "sentiment:aggregate",
    "Agregare trend sentiment B13 — avg last 30d vs prev 30d per client",
    NeuronType.KnowledgeNeuron,
    "churn-detection",
    5,
    "MEDIUM",
  ...
  n(
    "e5:decay:behavior-detect",
    "decay:behavior:detect",
    "Detectare pattern behavioral decay B14 — order frequency + engagement scădere",
    NeuronType.PredictiveNeuron,
    "churn-detection",
    5,
    "HIGH",
  ...
  // ── C15-C19: PostGIS Proximity Workers ────────────────────────────────────
  n(
    "e5:geo:proximity-calculate",
    "geo:proximity:calculate",
    "Calcul proximitate C15 — ST_DWithin KNN + UPSERT gold_proximity_scores",
    NeuronType.AssociativeNeuron,
    "geo-analysis",
    5,
    "MEDIUM",
  ...
  n(
    "e5:geo:neighbor-identify",
    "geo:neighbor:identify",
    "Identificare vecini C16 — proximityScore ≥ 0.6 → INSERT gold_entity_relationships",
    NeuronType.AssociativeNeuron,
    "geo-analysis",
    5,
    "MEDIUM",
  ...
  n(
    "e5:geo:territory-calculate",
    "geo:territory:calculate",
    "Calcul teritoriu C17 — ST_ConvexHull(ST_Collect) per cluster → UPDATE gold_clusters",
    NeuronType.KnowledgeNeuron,
    "geo-analysis",
    5,
    "LOW",
  ...
  n(
    "e5:geo:coverage-analyze",
    "geo:coverage:analyze",
    "Analiză coverage C18 — heatmap județ (count clienți, revenue, penetration rate)",
    NeuronType.KnowledgeNeuron,
    "geo-analysis",
    5,
    "LOW",
  ...
  n(
    "e5:geo:catchment-build",
    "geo:catchment:build",
    "Build catchment zones C19 — Voronoi-like nearest anchor per prospect KNN",
    NeuronType.AssociativeNeuron,
    "geo-analysis",
    5,
    "LOW",
  ...
  // ── D20-D24: Graph Community Detection ────────────────────────────────────
  n(
    "e5:graph:build-relationships",
    "graph:build:relationships",
    "Build graph relații D20 — noduri+muchii din orders+referrals+proximity",
    NeuronType.KnowledgeNeuron,
    "graph-community",
    5,
    "HIGH",
  ...
  n(
    "e5:community:detect-leiden",
    "community:detect:leiden",
    "Detectare comunități D21 — algoritm Leiden Python subprocess, timeout 600s",
    NeuronType.KnowledgeNeuron,
    "graph-community",
    5,
    "HIGH",
  ...
  n(
    "e5:centrality:calculate",
    "centrality:calculate",
    "Calcul centralitate D22 — degree/betweenness/pagerank per nod din graph",
    NeuronType.KnowledgeNeuron,
    "graph-community",
    5,
    "MEDIUM",
  ...
  n(
    "e5:kol:identify",
    "kol:identify",
    "Identificare KOL D23 — centrality + order volume + NPS ≥ 8 → tier micro/macro/mega",
    NeuronType.AssociativeNeuron,
    "graph-community",
    5,
    "HIGH",
  ...
  n(
    "e5:cluster:implicit-detect",
    "cluster:implicit:detect",
    "Detectare clustere implicite D24 — Jaccard bigrams affinity scoring",
    NeuronType.AssociativeNeuron,
    "graph-community",
    5,
    "MEDIUM",
  ...
  // ── E25-E31: Referral Pipeline ─────────────────────────────────────────────
  n(
    "e5:referral:detect",
    "referral:detect",
    "Detectare referaluri E25 — pattern ADVOCATE activity → candidați noi",
    NeuronType.ProceduralNeuron,
    "referral-management",
    5,
    "HIGH",
  ...
  n(
    "e5:referral:consent-request",
    "referral:consent:request",
    "Cerere consimțământ GDPR E26 — trimitere email/SMS candidat referit",
    NeuronType.ProceduralNeuron,
    "referral-management",
    5,
    "HIGH",
  ...
  n(
    "e5:referral:consent-confirm",
    "referral:consent:confirm",
    "Confirmare consimțământ E27 — webhook/click → UPDATE consent_status=GRANTED",
    NeuronType.ReflexNeuron,
    "referral-management",
    5,
    "HIGH",
  ...
  n(
    "e5:referral:outreach-prospect",
    "referral:outreach:prospect",
    "Outreach prospect referit E28 — email+call post-consent GDPR",
    NeuronType.MotorNeuron,
    "referral-management",
    5,
    "HIGH",
  ...
  n(
    "e5:referral:tracking-conversion",
    "referral:tracking:conversion",
    "Tracking conversie referral E29 — click/vizită/comandă → UPDATE referral status",
    NeuronType.SensoryNeuron,
    "referral-management",
    5,
    "MEDIUM",
  ...
  n(
    "e5:referral:reward-issue",
    "referral:reward:issue",
    "Emitere recompensă referral E30 — voucher/credit/comision post-conversie",
    NeuronType.ExecutiveNeuron,
    "referral-management",
    5,
    "HIGH",
  ...
  n(
    "e5:referral:reward-notify",
    "referral:reward:notify",
    "Notificare recompensă E31 — email/SMS advocate confirmare reward emis",
    NeuronType.MotorNeuron,
    "referral-management",
    5,
    "MEDIUM",
  ...
  n(
    "e5:winback:campaign-create",
    "winback:campaign:create",
    "Creare campanie win-back F32 — AT_RISK/CHURNED → planificare N pași",
    NeuronType.ExecutiveNeuron,
    "winback-campaigns",
    5,
    "HIGH",
  ...
  n(
    "e5:winback:step-execute",
    "winback:step:execute",
    "Execuție pas win-back F33 — email/SMS/apel conform plan campanie",
    NeuronType.MotorNeuron,
    "winback-campaigns",
    5,
    "HIGH",
  ...
  n(
    "e5:winback:offer-generate",
    "winback:offer:generate",
    "Generare ofertă personalizată win-back F34 — LLM-assisted cu SKU specific",
    NeuronType.DeliberativeNeuron,
    "winback-campaigns",
    5,
    "HIGH",
  ...
  n(
    "e5:winback:result-track",
    "winback:result:track",
    "Tracking rezultat win-back F35 — răspuns/conversie → UPDATE campaign status",
    NeuronType.SensoryNeuron,
    "winback-campaigns",
    5,
    "MEDIUM",
  ...
  n(
    "e5:winback:escalate-hitl",
    "winback:escalate:hitl",
    "Escalare HITL win-back F36 — automated fails → creare task human review",
    NeuronType.AlertNeuron,
    "winback-campaigns",
    5,
    "HIGH",
  ...
  // ── G37-G42: Association Scraping ──────────────────────────────────────────
  n(
    "e5:association:ouai-scrape",
    "association:ouai:scrape",
    "Scraping OUAI G37 — organizații utilizatori apă irigații, rateLimit=5/min",
    NeuronType.SensoryNeuron,
    "association-scraping",
    5,
    "LOW",
  ...
  n(
    "e5:association:madr-scrape",
    "association:madr:scrape",
    "Scraping MADR G38 — asociații agricole registru ministerial, rateLimit=5/min",
    NeuronType.SensoryNeuron,
    "association-scraping",
    5,
    "LOW",
  ...
  n(
    "e5:association:normalize",
    "association:normalize",
    "Normalizare asociații G39 — SIRUTA county, CUI format, dedup name",
    NeuronType.ProceduralNeuron,
    "association-scraping",
    5,
    "LOW",
  ...
  n(
    "e5:association:cui-lookup",
    "association:cui:lookup",
    "Lookup CUI G40 — ANAF OpenAPI validare cod fiscal entitate asociație",
    NeuronType.ToolNeuron,
    "association-scraping",
    5,
    "LOW",
  ...
  n(
    "e5:association:member-match",
    "association:member:match",
    "Potrivire membri G41 — Jaccard bigrams ≥ 0.45 → match cu clienți CerniqApp",
    NeuronType.AssociativeNeuron,
    "association-scraping",
    5,
    "MEDIUM",
  ...
  n(
    "e5:association:coverage-update",
    "association:coverage:update",
    "Update coverage G42 — UPDATE gold_association_coverage cu teritorii membre",
    NeuronType.MaintenanceNeuron,
    "association-scraping",
    5,
    "LOW",
  ...
  // ── H43-H47: Feedback NPS + Satisfaction ──────────────────────────────────
  n(
    "e5:feedback:nps-send",
    "feedback:nps:send",
    "Trimitere NPS H43 — survey post-interacțiune via email/SMS cu link unic",
    NeuronType.MotorNeuron,
    "feedback-nps",
    5,
    "MEDIUM",
  ...
  n(
    "e5:feedback:nps-process",
    "feedback:nps:process",
    "Procesare NPS H44 — clasificare promotor/pasiv/detractor + UPDATE gold_nps",
    NeuronType.EmotionNeuron,
    "feedback-nps",
    5,
    "HIGH",
  ...
  n(
    "e5:feedback:satisfaction-track",
    "feedback:satisfaction:track",
    "Tracking satisfacție H45 — scor per touchpoint (livrare/suport/produs)",
    NeuronType.EmotionNeuron,
    "feedback-nps",
    5,
    "MEDIUM",
  ...
  n(
    "e5:feedback:complaint-route",
    "feedback:complaint:route",
    "Rutare reclamație H46 — severity → agent/HITL/escalare conform reguli",
    NeuronType.ReflexNeuron,
    "feedback-nps",
    5,
    "HIGH",
  ...
  n(
    "e5:feedback:report-generate",
    "feedback:report:generate",
    "Generare raport feedback H47 — periodic per tenant cu NPS trend + insights",
    NeuronType.KnowledgeNeuron,
    "feedback-nps",
    5,
    "LOW",
  ...
  // ── I48-I51: Content Drip ──────────────────────────────────────────────────
  n(
    "e5:content:drip-schedule",
    "content:drip:schedule",
    "Planificare drip I48 — secvență conținut per stadiu lifecycle client",
    NeuronType.ProceduralNeuron,
    "content-drip",
    5,
    "MEDIUM",
  ...
  n(
    "e5:content:drip-execute",
    "content:drip:execute",
    "Execuție drip I49 — trimitere email/SMS/push pas individual planificat",
    NeuronType.MotorNeuron,
    "content-drip",
    5,
    "MEDIUM",
  ...
  n(
    "e5:content:template-render",
    "content:template:render",
    "Render template I50 — personalizare conținut cu date client specific",
    NeuronType.DeliberativeNeuron,
    "content-drip",
    5,
    "LOW",
  ...
  n(
    "e5:content:delivery-track",
    "content:delivery:track",
    "Tracking livrare I51 — open/click/bounce events → UPDATE gold_content_delivery",
    NeuronType.SensoryNeuron,
    "content-drip",
    5,
    "LOW",
  ...
  n(
    "e5:alert:weather-monitor",
    "alerts:weather:monitor",
    "Monitorizare meteo J52 — polling ANM/OpenMeteo, detectare condiții agri critice",
    NeuronType.AlertNeuron,
    "alerts-weather",
    5,
    "HIGH",
  ...
  n(
    "e5:alert:weather-match",
    "alerts:weather:match",
    "Potrivire alertă meteo J53 — match alertă cu zone geo clienți afectați",
    NeuronType.AssociativeNeuron,
    "alerts-weather",
    5,
    "HIGH",
  ...
  n(
    "e5:alert:apia-seasonal",
    "alerts:apia:seasonal",
    "Alertă APIA sezonală J54 — subvenții + programe agricole APIA active",
    NeuronType.SensoryNeuron,
    "alerts-weather",
    5,
    "MEDIUM",
  ...
  n(
    "e5:alert:campaign-trigger",
    "alerts:campaign:trigger",
    "Trigger campanie alertă J55 — condiție alertă → lansare campanie targeted",
    NeuronType.ExecutiveNeuron,
    "alerts-weather",
    5,
    "HIGH",
  ...
  // ── K56-K58: Compliance GDPR + Competition Law ─────────────────────────────
  n(
    "e5:compliance:gdpr-check",
    "compliance:gdpr:check",
    "Verificare GDPR K56 — consent activ per acțiune comunicare, purge non-consimțit",
    NeuronType.ComplianceNeuron,
    "audit-compliance",
    5,
    "CRITICAL",
  ...
  n(
    "e5:compliance:competition-law",
    "compliance:competition:law",
    "Verificare concurență K57 — review campanii pentru respectare lege concurență",
    NeuronType.ComplianceNeuron,
    "audit-compliance",
    5,
    "HIGH",
  ...
  n(
    "e5:compliance:data-retention",
    "compliance:data:retention",
    "Retenție date K58 — purge date expirate conform politică retenție per tip",
    NeuronType.MaintenanceNeuron,
    "audit-compliance",
    5,
    "HIGH",
