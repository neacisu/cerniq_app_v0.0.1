/**
 * Runtime API (Fastify) — încărcat după initTelemetry() din `index.ts`
 * ca instrumentările OTel să poată patch-ui modul `fastify` la timp.
 */
...
import { shutdownTelemetry } from "@cerniq/observability";
