          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-s700">
                ...
                <th className="text-left py-3 px-4 text-t3 font-medium">Parcels</th>
                <th className="text-left py-3 px-4 text-t3 font-medium">County</th>
            ...
            <tbody>
              {MOCK_AWBS.map((a) => (
                <tr key={a.awb} className="border-b border-s800 hover:bg-s800/50">
                  <td className="py-3 px-4">
                    <button
                      type="button"
                      onClick={() => handleAwbClick(a.awb)}
                      className="text-b5 hover:underline cursor-pointer"
                    >
                      {a.awb}
                    </button>
                  </td>
                  <td className="py-3 px-4 text-t1">{a.company}</td>
