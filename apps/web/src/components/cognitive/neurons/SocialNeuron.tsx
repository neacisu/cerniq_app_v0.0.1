/**
 * SocialNeuron — E5 Referral GDPR Social (E25-E31)
 *
 * Visual: pink bright glow — oklch(0.35 0.08 340)
 * Swimlane: social-graph
 * Icon: Users — rețele sociale și propagare referral GDPR-compliant
 */
...
export type SocialNeuronType = Node<NeuronNodeData, "social-neuron">;

const COLOR = "var(--color-neuron-social)";

export const SocialNeuronComponent = memo(function SocialNeuronComponent({
  data,
  selected,
}: NodeProps<SocialNeuronType>) {
  ...
  return (
    <div
      data-testid="social-neuron"
      data-neuron-type="SocialNeuron"
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 7, marginTop: 4 }}>
        <Users size={14} color={COLOR} strokeWidth={2} aria-hidden />
        <span
          style={{
            fontSize: 11,
            fontWeight: 600,
