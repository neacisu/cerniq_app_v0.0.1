/**
 * ToolNeuron — E3 MCP Tools Layer (L66-L70)
 *
 * Visual: cyan bright — oklch(0.35 0.07 200)
 * Swimlane: ai-reasoning
 * Analogie biologică: Cortex motor — execuție instrumente
 */
...
export type ToolNeuronType = Node<NeuronNodeData, "tool-neuron">;

const COLOR = "var(--color-neuron-tool)";

export const ToolNeuronComponent = memo(function ToolNeuronComponent({
  data,
  selected,
}: NodeProps<ToolNeuronType>) {
  ...
  return (
    <div
      data-testid="tool-neuron"
      data-neuron-type="ToolNeuron"
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 7, marginTop: 4 }}>
        <Wrench size={14} color={COLOR} strokeWidth={2} aria-hidden />
        <span
          style={{
            fontSize: 11,
            fontWeight: 600,
      ...
      {data.showMetrics && (
        ...
        >
          <span>calls: {data.metrics.processed}</span>
