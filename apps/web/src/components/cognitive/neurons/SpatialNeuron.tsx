/**
 * SpatialNeuron — E5 Geo/Spatial (C15-C19)
 *
 * Visual: pink bright glow — oklch(0.35 0.08 340)
 * Swimlane: social-graph
 * Icon: MapPin — ancorare geografică și teritorii
 */
...
export type SpatialNeuronType = Node<NeuronNodeData, "spatial-neuron">;

const COLOR = "var(--color-neuron-social)";

export const SpatialNeuronComponent = memo(function SpatialNeuronComponent({
  data,
  selected,
}: NodeProps<SpatialNeuronType>) {
  ...
  return (
    <div
      data-testid="spatial-neuron"
      data-neuron-type="SpatialNeuron"
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 7, marginTop: 4 }}>
        <MapPin size={14} color={COLOR} strokeWidth={2} aria-hidden />
        <span
          style={{
            fontSize: 11,
            fontWeight: 600,
