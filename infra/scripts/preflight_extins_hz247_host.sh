...
sudo iptables -S | grep -E "10\\.0\\.1\\.10/32|--dport (443|6379)|--dports 19100|--dports 29100|10\\.0\\.1\\.(109|110)/32|10\\.0\\.0\\.2/32" | sed -n "1,200p" || true
echo

echo "# iptables: FORWARD egress policy excerpts (CT107/108/109/110)"
sudo iptables -S FORWARD | grep -E "10\\.0\\.1\\.(107|108|109|110)/32" | sed -n "1,260p" || true
echo
